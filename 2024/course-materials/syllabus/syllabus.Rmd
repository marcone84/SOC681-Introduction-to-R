...
# ASSESSMENT
100% of your grade will be based on a "final paper" (at least 5,000 words) that uses some kind of computational method covered in this course. This paper will be assessed by 1) relevance to a particular field, 2) justification of hypotheses, 3) justification of computational method, and 3) clear communication of results (including at least one data viz) and implications. This paper has no other parameters. 
